...
function Navbar() {
  ...
  return (
    <div className={`fixed z-10 top-0 w-full lg:px-5 ${scrollY>150?"bg-white text-[#eb2348] shadow-lg shadow-[#00000011]":"text-white bg-black md:bg-transparent"} transition-all duration-200`} style={{fontFamily:"poppins"}}>
      <div className='flex items-center justify-center md:justify-between flex-row'>
        ...
        <div className=''>
          <img src={scrollY>150?Logo:LogoDark} alt="Logo" className='w-32 md:ml-8 my-1' style={{filter:"drop-shadow(0px 0px 0.4px black"}}/>
        </div>
        <ul className={`flex items-center justify-center flex-col md:flex-row gap-5 absolute ${scrollY>150?"bg-white md:bg-transparent":"bg-black md:bg-transparent"} ${menu?"top-16":"-top-96"} py-5 left-0 w-screen md:top-0 md:py-0 md:h-auto md:w-auto md:relative uppercase font-medium text-sm lg:text-base transition-all duration-500`}>
